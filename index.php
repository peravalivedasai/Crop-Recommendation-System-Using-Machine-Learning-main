                    ...
                    <div class="col-lg-4 col-md-12 pt-5 mb-5">
                        ...
                        <div class="d-flex mb-2">
                            ...
                            <p class="text-white mb-0">
                                Krishna University College of Arts and Science, Rudravaram
                            </p>
                        </div>
                        <div class="d-flex mb-2">
                            <i class="bi bi-envelope-open text-white me-2"></i>
                            <p class="text-white mb-0">hemasreesammeta346@gmail.com</p>
                        </div>
                        <div class="d-flex mb-2">
                    ...
                    <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            ...
                            <a class="text-white mb-2" href="#">
                                <i class="bi bi-arrow-right text-white me-2"></i>Our Services
                            </a>
                            <a class="text-white" href="#">
                                <i class="bi bi-arrow-right text-white me-2"></i>Contact Us
                            </a>
                        </div>
                    </div>
                </div>
