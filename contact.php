    ...
    <nav class="navbar navbar-expand-lg bg-primary navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav mx-auto py-0">
                ...
                <a href="about.php" class="nav-item nav-link">About</a><div class="nav-item dropdown">
    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Types of Soil</a>
    <div class="dropdown-menu m-0">
        <a href="#" class="dropdown-item soil-link">Sandy soil</a>
        <a href="#" class="dropdown-item soil-link">Loamy soil</a>
        <a href="#" class="dropdown-item soil-link">Black soil</a>
        <a href="#" class="dropdown-item soil-link">Red soil</a>
        <a href="#" class="dropdown-item soil-link">Clayey soil</a>
    </div>
</div>

<script>
    // Select all dropdown items with the class 'soil-link'
    document.querySelectorAll('.soil-link').forEach(item => {
        item.addEventListener('click', function (e) {
            e.preventDefault(); // Prevent default link behavior
            alert("Please login if you want to use the model");
        });
    });
</script>
    ...
    <div class="bg-primary h-100 p-5">
        <form action="contact2.php" method="POST">
            <div class="row g-3">
                ...
                <div class="col-12">
                    <textarea name="message" class="form-control bg-light border-0 px-4 py-3" rows="2" placeholder="Message" required></textarea>
                </div>
                <div class="col-12">
                    ...
                    <div class="bg-secondary h-100 p-5">
                        ...
                        <div class="d-flex mb-4">
                            ...
                            <div class="ps-3">
                                ...
                                <span class="text-white">Krishna university college of arts and science,Rudravaram</span>
                            </div>
                        </div>
                        <div class="d-flex mb-4">
                            <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center" style="width: 60px; height: 60px;">
                            ...
                            <div class="ps-3">
                                ...
                                <span class="text-white">hemasreesammeta346@gmail.com</span>
                            </div>
                        </div>
                        <div class="d-flex">
                            <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center" style="width: 60px; height: 60px;">
                            ...
                            <div class="ps-3">
                                ...
                                <span class="text-white">+91 81210 83758</span>
                            </div>
                        </div>
                    </div>
                </div>
